...
const Sidebar = () => {
  ...
  const handleNewChat = () => {
    ...
    setRecentChats((prevChats) => [
      newChat,
      ...prevChats.filter((chat) => chat.id !== newId),
    ]);
    ...
    <aside className={`sidebar ${isSidebarOpen ? "" : "collapsed"}`}>
      ...
      <div className="sidebar-top">
        ...
        >
          ...
          {isSidebarOpen && (
            <span className="new-chat-text">Start New Vision</span>
          )}
      ...
      <div className="sidebar-bottom">
        ...
        <div
          className="sidebar-item user-profile"
          onClick={() => navigate("/profile")}
        >
          <span className="icon">👤</span>
          {isSidebarOpen && "Profile (Noah)"}
        </div>
        <div className="sidebar-item home" onClick={() => navigate("/")}>
          <span className="icon">🏠</span>
          {isSidebarOpen && "Home"}
        </div>
      </div>
